...
console.log(yanzhengphoneinput)
...
duanxin.addEventListener('click', () => {
  ...
  if (currentduanxin == 0) {
    if (duanxinflag) {
      ...
      duanxinflag = 0
      let timer = 180
      fetch('http://zhihu.madeindz.work:3920/getcode', {
        method: 'post',
        headers: {
...
registerbtn.addEventListener('click', (e) => {
  ...
  fetch('http://zhihu.madeindz.work:3920/register', {
    method: 'post',
    headers: {
      'Content-Type': 'application/json',
    },
...
if (localStorage.getItem('token')) {
  window.location.href = 'http://127.0.0.1:5502/startText/html/index.html'
} else {
  //电话号验证码登录
  loginOR.addEventListener('click', (e) => {
    ...
    fetch('http://zhihu.madeindz.work:3920/phonelogin', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  login.addEventListener('click', (e) => {
    ...
    if (reg.test(Id)) {
      const email = Id
      fetch('http://zhihu.madeindz.work/emaillogin', {
        method: 'post',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      fetch('http://zhihu.madeindz.work:3920/phonepasswordlogin', {
        method: 'post',
        headers: {
          'Content-Type': 'application/json',
        },
